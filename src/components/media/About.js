      ...
      <div className="flex w-[80%] flex-col lg:flex-row">
        ...
        <div className="lg:ml-8 lg:pt-4 xl:pt-4">
          ...
          <div className="flex mt-8">
            ...
            <a href="#stay">
              <button className="mr-8 sm:text-lg lg:text-2xl flex items-center font-light hover:border-b-2 text-[#7b7b7b] hover:scale-110 origin-left duration-200 cursor-pointer">
